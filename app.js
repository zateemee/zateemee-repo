...
function showGown(name){
 ...
 const enquiry=document.createElement('a');enquiry.className='button burgundy';enquiry.href='contact.html?interest=bespoke';enquiry.textContent='Enquire about '+g.name;document.querySelector('.detail-copy').append(enquiry);
